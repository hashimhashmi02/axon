...
const formSchema = z.object({
    ...
    username: z.string()
        .refine((val) => !val || !val.toLowerCase().includes('discord'), {
            message: "Username cannot contain 'discord' (Discord API restriction)"
        })
        .optional(),
    content: z.string()
...
export const DiscordDialog = ({
    ...
    const watchVariableName = form.watch("variableName") || "myDiscordResponse";
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Get this from Discord Channel Settings - Integrations  - New Webhook
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            placeholder="Axon Bot"
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormDescription>
                                        The username to use for the webhook
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
